...
class GameEngine(object):
    ...
    def __init__(self):
        ...
        self.ghost_starting_position = (14, 14) 

        self.levelObjectNamesBlocker = ["wall", "cage"]
        self.levelObjectNamesPassable = ["empty", "pellet", "powerup","heart"]
        ...
        for levelLine in levelFile.readlines():
            ...
            for i in range(28):
                ...
                if levelLineSplit[i] == "_":    # passage
                    ...
                    self.levelObjects[i][levelLineNo].name = "heart"
    ...
    def encounterFixed(self, x, y):     # rel coord.
        ...
        elif self.levelObjects[x][y].name == "heart":
            result = "heart"
