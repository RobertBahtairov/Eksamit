...
class MainEngine(object):
    ...
    def __initWidgets(self):
        ...
        self.wLvLabel = Label(self.root, text="Vali mis tased sa tahat (1 - 7).")
        self.wLvEntry = Entry(self.root)
        self.wLvBtn = Button(self.root, text="Vali", command=self.lvSelect, width=5, height=1)
        self.wLvText = Label(self.root, text="Kasuta Nooleklahve ,et liikuta.\r\nESC nupp ,et mäng lõppedata.\r\npellet on 20 punkti.\r\nSuper pellet 100 punkti.\r\nSüda annab 1 elu juurde.")

        # initialize widgets for the game
        self.wGameLabelScore = Label(self.root, text=("Skoor: " + str(self.statusScore)))
        self.wGameLabelLife = Label(self.root, text=("Elu: " + str(self.statusLife)))
    ...
    def lvSelect(self):
        try:
            ...
            messagebox.showinfo("Error!", "Sissesta päris tase!.")
    ...
    def encounterEventDeadRestart(self):
        ...
        if self.statusLife >= 0:
            ...
            field.gameEngine.levelpowerupRemaining = 0
            self.__initLevel(self.currentLv)
